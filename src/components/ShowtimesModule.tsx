...
export const ShowtimesModule: React.FC<ShowtimesModuleProps> = ({ showtimes, setShowtimes, movies, rooms }) => {
  ...
  const handleAddShowtime = (roomId: string) => {
    ...
    const startTime = `${selectedDate}T10:00:00`;
    const endTime = `${selectedDate}T12:00:00`;
    ...
    <div className="space-y-6">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-3">
          ...
          <button onClick={() => handleAddShowtime(rooms[0]?.id)} className="bg-yellow-500 text-black px-4 py-2 rounded-xl font-bold flex items-center gap-2 hover:bg-yellow-400 transition-all">
