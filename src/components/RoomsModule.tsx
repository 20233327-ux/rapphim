...
export const RoomsModule: React.FC<RoomsModuleProps> = ({ rooms, setRooms }) => {
  ...
  return (
    <div className="space-y-8">
      <div className="flex items-center justify-between">
        ...
        <button onClick={handleAddRoom} className="bg-yellow-500 text-black px-4 py-2 rounded-xl font-bold flex items-center gap-2 hover:bg-yellow-400 transition-all">
          ...
          >
            ...
            <div className="flex items-center justify-between pt-4 border-t border-zinc-800">
              ...
              <div className="flex gap-2">
                ...
                <button onClick={(e) => { e.stopPropagation(); handleDelete(room.id); }} className="p-1.5 text-zinc-500 hover:text-red-500 transition-colors"><Trash2 size={14}/></button>
              </div>
            </div>
          </div>
        ))}
